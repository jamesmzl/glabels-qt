...
//			glbarcode::Factory::registerType( "gnu-barcode::code39",   GnuBarcode::Code39::create );
            glbarcode::Factory::registerType( "code128",  GnuBarcode::Code128::create );
            glbarcode::Factory::registerType( "code128c", GnuBarcode::Code128C::create );
            glbarcode::Factory::registerType( "code128b", GnuBarcode::Code128B::create );
...
//			glbarcode::Factory::registerType( "gnu-barcode::pls",      GnuBarcode::Pls::create );
            glbarcode::Factory::registerType( "code93",   GnuBarcode::Code93::create );
...
//			               true, true, true, true, "0000000000", true, 10 );
            registerStyle( "code128", "", tr("Code 128"),
                           true, true, true, true, "0000000000", true, 10 );
            registerStyle( "code128c", "", tr("Code 128C"),
                           true, true, true, false, "0000000000", true, 10 );
            registerStyle( "code128b", "", tr("Code 128B"),
                           true, true, true, true, "0000000000", true, 10 );
...
//			               true, true, true, true, "0000000000", true, 10 );
            registerStyle( "code93", "", tr("Code 93"),
			               true, true, true, false, "0000000000", true, 10 );
...
//			registerBackend( "qrencode", "QREncode" );
            ...
            glbarcode::Factory::registerType( "qrcode", QrEncode::QrCode::create );

            registerStyle( "qrcode", "", tr("IEC18004 (QRCode)"),
			               false, false, true, false, "1234567890AB", false, 12 );
#endif // HAVE_QRENCODE
